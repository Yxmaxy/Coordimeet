...
from simple_notifications.services import NotificationSubscriptionService
...
class CoordimeetUserServices:
    ...
    def cleanup_anonymous_user(request: Request, response: Response) -> None:
        ...
        if anonymous_user := CoordimeetUserServices.get_anonymous_user_from_cookie(request):
            for subscription in NotificationSubscriptionService.get_user_subscriptions(anonymous_user):
                NotificationSubscriptionService.delete_user_subscription(anonymous_user, subscription_id=subscription.id)
